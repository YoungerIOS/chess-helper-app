"""CLI: 从一个或多个 JJ v2 会话构建棋子分类样本。"""

import argparse
import json

from .dataset_builder import JJV2DatasetBuilder


def main() -> None:
    parser = argparse.ArgumentParser(description="构建新版 JJ 棋子训练样本")
